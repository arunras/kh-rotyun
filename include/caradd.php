...
echo '<script type="text/javascript" src="'.HTTP_DOMAIN.'js/yearforadd.js"></script>';
//Form Validation
...
<div style="border-bottom: 1px #CCC solid; font-size: 20px;margin-bottom: 30px;"><?php echo $rLanguage->text("New Car");?></div>
<div class="CAR_REGISTRATION">
<table border="0px" width="100%">
	<tr>
    	<td width="400px">
	<form action="<?php echo HTTP_DOMAIN;?>include/php_sub/car_add.php" id="iform_caradd" method="post" enctype="multipart/form-data" style="border: 0px #00F solid;">
    	<table>
        	<tr>
            	<td class="label"><?php echo $rLanguage->text("Model");?></td>
                <td>
                	<input type="hidden" class="textbox" name="storeid" value="<?php echo $store_id;?>"/>
                	<input type="text" class="textbox" name="model" id="imodel" autofocus="autofocus"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select name="releasedyear" id="iyear" class="selection"></select>
                    <script type="text/javascript">date_populate("iyear");</script>
                </td>
            </tr>
            <tr>
            	<td class="label"><?php echo $rLanguage->text("Color");?></td>
                <td><input type="text" class="textbox" name="color" id="icolor" /></td>
            </tr>
            <tr>
            	<td class="label"><?php echo $rLanguage->text("Mileage");?></td>
                <td><input type="text" class="textbox" name="mileage" id="imileage"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="textbox" name="noseat" id="inoseat" /></td>
            </tr>
            <tr>
            	<td class="label"><?php echo $rLanguage->text("Number of Door");?></td>
                <td><input type="text" class="textbox" name="nodoor" id="inodoor" /></td>
            </tr>
            <tr>
            	<td class="label"><?php echo $rLanguage->text("Label Number");?></td>
                <td><input type="text" class="textbox" name="labelnumber" id="ilabelnumber"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="textbox" name="enginesize" id="ienginesize" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td class="label"><?php echo $rLanguage->text("Price").'($)';?></td>
                <td><input type="text" class="textbox" name="price" id="iprice" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td class="label"></td>
                <td>
                	<input type="button" name="btn_add" id="ibtn_add" value="<?php echo $rLanguage->text("Add");?>" onclick="return submitCarAdd();" />
    	...
    	<td valign="top">
        	<div class="activeBlock">
            	<input type="checkbox" name="active" value="1">Activate
        	</div>
...
<script type="text/javascript">
	function submitCarAdd(){
		if(file_validation('icarpicture')==true){
    		$('form#iform_caradd').submit();
		}
	}
