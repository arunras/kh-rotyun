<div class="box col1">
    <p>'.$car_id.' Fusce accumsan mollis eros. Pellentesque a diam sit amet mi ullamcorper vehicula  </p>
</div>'
<div class="box col1">
    <p>'.$car_id.' Fusce accumsan mollis eros. Pellentesque a diam sit amet mi ullamcorper vehicula  </p>
</div>'
...
function getCarAllMake(){
	$q_car_id=getResultSet("SELECT car_id FROM tbl_car ORDER BY car_id DESC LIMIT 100");
	$i = 0;
	$medium_index = 3;
	$big_index = 2;
